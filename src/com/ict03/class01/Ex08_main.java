...
public class Ex08_main {
	public static void main(String[] args) {
		 ...
		 * Ex08[] arr = new Ex08[4];
		 * 
		 * arr[0] = coffee; arr[1] = ion; arr[2] = cola; arr[3] = juice;
		 */

		Ex08[] arr = { coffee, ion, cola, juice };
		// arr[]이 가지고있는 이름들을 출력하자
		/*
		 * for (int i = 0; i < arr.length; i++) { System.out.print(arr[i].getName() +
		...
		//잔돈이 남으면 다시뽑을수 있도록 while문으로 바꿔보기
