	...
	public static void main(String[] args) {
		...
		esc: while (true) {
			...
			case 1:
				...
				// 삽입하는 메소드
				Ex05_DAO2.getInstance().getInsert(i_bookid, i_bookname, i_publisher, i_price);				
				break;
			...
			case 2:
				...
				// 삭제할 메소드
				Ex05_DAO2.getInstance().getDelete(delete_id);
				break;
			...
			case 3:
				...
				// 수정할 메소드
				Ex05_DAO2.getInstance().getUpdate(u_bookid, u_bookname, u_publisher, u_price);
				break;
			...
			case 4:
				...
				// 검색할 메소드
				Ex05_DAO2.getInstance().getSelect(s_bookid);
				break;
			default:
